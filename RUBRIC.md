...
| **35** | *The Cove* (m660) | Real, discrete tension in specific covert-filming sequences (hidden cameras, the night reveal), but structured as episodic heist-thriller excitement rather than continuous ambient pressure — much closer in shape to *Inglourious Basterds* than to *Jaws*, just with fewer and less oppressive peaks. Critically, most of what makes the film feel heavy is the SUBJECT MATTER (the dolphin slaughter it exposes), which this construct's own "this is NOT" list excludes: *"A film about a terrible event is not automatically high — dread is in the handling, not the topic."* Strip the subject matter out and what's left is a well-made, episodically-structured exposé thriller. |
| **20** | *The Princess Bride* (m145) | Peril exists and is never once unsettling. |

> **RATIFIED 2026-09-11.** The self-consistency test (`evidence/calibration/self-consistency-report.md`) found this construct's only failing MAD (7.07, vs. ~6 everywhere else) traced to exactly this gap: anchors jumped from 55 straight to 20 with nothing between, and 7 of 30 test works disagreed by 15–20 points, all in the 20–85 mid-band, all the same underlying question — how much episodic structure should discount real tension once it's present. *The Cove* was itself one of the disagreement cases (two independent blind passes scored it 55 and 35); 35 was chosen as the more rubric-faithful reading once the subject-matter exclusion is applied strictly, not because it splits the difference. `atmosphericDreadIndex` is now the eighth Phase C construct, scored on the same footing as the other seven.
