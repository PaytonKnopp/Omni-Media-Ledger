...
## Deep Impact (m1259)
- **runtime (min)** -- corpus has `121`, sources disagree (edition-dependent): OMDb `120`, TMDB `122`  _(corpus value does not match either source (OMDb 120, TMDB 122) -- treated as a distinct edition; the specific cut is not identified from available evidence.)_
