...
## Zoolander 2 (m1812)
- **runtime (min)** -- corpus has `102`, sources disagree (edition-dependent): OMDb `101`, TMDB `100`  _(corpus value does not match either source (OMDb 101, TMDB 100) -- treated as a distinct edition; the specific cut is not identified from available evidence.)_
