...
function renderMatrices(ALL,$,$$){
 ...
 $('#matrixWrap').innerHTML=
  ...
  +matrixBlock('♫ Soundtrack &amp; Audio Hall','Reference scores and sound design — the works that justify the speakers. Soundtrack index &ge; 90.',ALL.filter(x=>x.snd>=90&&idxApplies(x,'snd')).sort((a,b)=>b.snd-a.snd),it=>[[it.snd,'#7dd3fc'],[it.ref,'#818cf8']],['Audio','4K'])
